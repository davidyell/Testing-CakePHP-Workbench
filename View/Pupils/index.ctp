<div class="pupils index">
	...
	<tr>
		...
		<td><?php echo h($pupil['Pupil']['student_number']); ?>&nbsp;</td>
		<td><?php echo h($pupil['Pupil']['created']); ?>&nbsp;</td>
		<td><?php echo h($pupil['Pupil']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $pupil['Pupil']['id']), null, __('Are you sure you want to delete # %s?', $pupil['Pupil']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
